...
Sendo $J(\boldsymbol{\theta})$ mede a agregação dos  erros individuais em um único valor a ser minimizado.
...
Uma soma de valores _não seria adequada_, pois erros positivos e negativos poderiam se cancelar.
